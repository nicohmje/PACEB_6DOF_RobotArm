...
def generate_launch_description():
    ...
    moveit_config = MoveItConfigsBuilder("nick_bot", 
        package_name="nick_bot_moveit_config").robot_description(file_path="config/nick_bot.urdf.xacro").robot_description_semantic(file_path="config/nick_bot.srdf").joint_limits(file_path="config/joint_limits.yaml").pilz_cartesian_limits(file_path="config/pilz_cartesian_limits.yaml").robot_description_kinematics(file_path="config/kinematics.yaml").to_moveit_configs()
    ...
    #delay_move_group = TimerAction(period=1.0, actions=[move_group_node])
